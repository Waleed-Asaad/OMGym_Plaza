            ...
            if (!empty($trainingPlans)) {
                ...
                foreach ($top_trainingPlans as $trainingPlan) {
                    if ($trainingPlan['score'] > 0) {
                        ...
                        $score = $trainingPlan['score'];
                        $percentage = number_format(($score / $total_attributes) * 100, 2);
                        echo '<div class="gs-item grid-wide set-bg" data-setbg="img/training_plans/'.$trainingPlanImg.'" style="width:750px; height:1200px; margin-bottom:400px;">
                                <a href="img/training_plans/'.$trainingPlanImg.'" class="thumb-icon image-popup"><i class="fa fa-picture-o"></i></a>

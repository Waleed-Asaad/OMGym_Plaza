...
function getUnreadMessagesCount($trainerId, $conn) {
    $sql = "SELECT COUNT(*) as unreadCount FROM messages WHERE trainerId = ? AND readed = 0";
    $stmt = $conn->prepare($sql);
...
$unreadCount = getUnreadMessagesCount($trainerId, $conn);
?>
